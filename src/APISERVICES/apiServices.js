...
import qs from "qs";
const baseUrl = "https://silencer-percolate-delegator.ngrok-free.dev/api"; // Replace with your actual API base URL
class apiServices {
...
getallPenaltyRules(data) {
    return axios.post(`${baseUrl}/penalty-rule/all`, data, { headers: this.getToken() })
}
getSinglePenaltyRule(data) {
    return axios.post(`${baseUrl}/penalty-rule/single`, data, { headers: this.getToken() })
}

addPenaltyRule(data) {
    return axios.post(`${baseUrl}/penalty-rule/add`, data, { headers: this.getToken() })
}

updatePenaltyRule(data) {
    return axios.post(`${baseUrl}/penalty-rule/update`, data, { headers: this.getToken() })
}

deletePenaltyRule(data) {
    return axios.post(`${baseUrl}/penalty-rule/delete`, data, { headers: this.getToken() })
}
}
